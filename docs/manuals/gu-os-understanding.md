...
4. **Adopción en runtime — todavía parcial:** ese substrato **aún no gobierna el producto**. Solo el **Work Portfolio**, una proyección supervisora de los Casos de la Organización, ejerce hoy autorización por Organización desde una route HTTP. Lo hace su página (`/portfolio`, R1 SL-7) y, desde R1 SL-12, el chat web mediante la tool de solo lectura `work_portfolio_read`. Ningún cron lo hace, y admisión, resolución y supervisor siguen ejercitándose con selftests, evals y verificadores operados a mano. Por eso el punto 2 sigue siendo el enlace de negocio efectivo.
