...
4. **Adopción en runtime — todavía parcial:** ese substrato **aún no gobierna el producto**. La única route HTTP que ejerce hoy autorización por Organización es el **Work Portfolio** (`/portfolio`, R1 SL-7), una proyección supervisora de los Casos de la Organización; ningún cron lo hace, y admisión, resolución y supervisor siguen ejercitándose con selftests, evals y verificadores operados a mano. Por eso el punto 2 sigue siendo el enlace de negocio efectivo.
