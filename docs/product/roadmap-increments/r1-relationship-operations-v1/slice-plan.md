...
> **Version:** v1.12  
> **Status:** Approved — governing R1 Slice Plan. **SL-0, SL-1 and SL-2 are Done** (§6; SL-1 was reopened once after Done and re-closed); **SL-3 and SL-4 are READY** (§4, §9) and their case-B prerequisite on SL-2 is now satisfied; SL-5…SL-13 remain rolling-wave stubs and are NOT READY. Current Execution Cycle and Accountable / DRI planning facts are recorded in §5; **execution stage is not owned by this artifact** (Methodology §19.1–§19.2)  
...
> **Technical Plan:** [`technical-plan.md`](technical-plan.md) (v1.7)  
...
| SL-3 | Duplicate & supersession flows | behavior | SL-0 ✓, SL-2 ✓ | Duplicate and superseded leads resolve to one canonical Opportunity with queryable lineage, without mutating Case rows | **RS-2** | **READY** — elaborated and evaluated 2026-09-05 (§4, §9); estimate frozen; **case-B prerequisite on SL-2 satisfied 2026-09-06** |
| SL-4 | Supervisor loop (shadow) | behavior | SL-2 ✓ | Multi-day shadow Opportunities carry a coherent posture history and tracked commitments, reconstructable by replay | **RS-2** | **READY** — elaborated and evaluated 2026-09-05 (§4, §9); estimate frozen; **case-B prerequisite on SL-2 satisfied 2026-09-06** |
...
**Bounded production access, accounted exactly.** Five real Traditional Gu production leads were read across two separately authorized rounds — three under the original ceiling, two under a later evidence-selection authorization — plus an owner-scoped discovery pass of 25 lead records and 5 conversations. **Zero Traditional Gu writes. No global or unbounded scan.** Four of the five were not admitted, and each for a reason the contract requires: one out of tenancy, two with no actionable objective, one whose objective had been explicitly withdrawn.
